package com.javafreelancedeveloper.springbootcassandra.controller;
...
import com.javafreelancedeveloper.springbootcassandra.converter.ProductToProductForm;
...
public class ProductController {
	...
	public String newProduct(Model model) {
		...
		productForm.setId(UUIDs.timeBased().toString());
		model.addAttribute("productForm", productForm);
		return "product/productform";
	}
